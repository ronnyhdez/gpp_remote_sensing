...
as Vapor Pressure Deficit (VPA), Air Temperature (TA), Latent Heat (LH) and
relative humidity (RH). In order to explore these variables, I plotted them with
box plots to check the variability outliers and patterns per month, across all
the time range available (May 2013 to May 2017).
